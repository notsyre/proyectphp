...
$sql="SELECT * FROM cordinador WHERE cod_cordinador='$id'";
...
<html lang="en">
    ...
    <body>
                <div class="container mt-5">
                    <form action="updateCordi.php" method="POST">
                    
                                <input type="hidden" name="cod_cordinador" value="<?php echo $row['cod_cordinador']  ?>">
